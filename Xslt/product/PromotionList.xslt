    ...
    <div class="promo-list-heading flex justify-between items-center">
      <div class="promo-title flex items-center">
        <div class="icon flex flex-center">
          <img class="lazyload" alt="khuyến mãi" data-src="/Data/Sites/1/skins/default/img/promo/icon-title.png" src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" />
        </div>
