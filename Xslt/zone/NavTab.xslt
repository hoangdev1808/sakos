		...
		<div class="wrap-top">
			<div class="wrap-left">
				<ul class="color-text f-14">
					...
					<li>
						<xsl:if test="CurrentZoneId = 1720">
							<xsl:attribute name="class">
								<xsl:text disable-output-escaping="yes">active</xsl:text>
							</xsl:attribute>
						</xsl:if>
						<xsl:if test="CurrentZoneId = 1748">
							<xsl:attribute name="class">
								<xsl:text disable-output-escaping="yes">active</xsl:text>
							</xsl:attribute>
						</xsl:if>
						<xsl:if test="CurrentZoneId = 1749">
							<xsl:attribute name="class">
								<xsl:text disable-output-escaping="yes">active</xsl:text>
							</xsl:attribute>
						</xsl:if>
						<xsl:if test="CurrentZoneId = 1750">
							<xsl:attribute name="class">
								<xsl:text disable-output-escaping="yes">active</xsl:text>
							</xsl:attribute>
						</xsl:if>
						<xsl:if test="CurrentZoneId = 1751">
							<xsl:attribute name="class">
								<xsl:text disable-output-escaping="yes">active</xsl:text>
							</xsl:attribute>
						</xsl:if>
						<a>
							<xsl:attribute name="href">
								<xsl:value-of select="Zone[IsActive='true']/Url"></xsl:value-of>
							</xsl:attribute>
